                ...
                <div class="mt-5">
                  ...
                  <form wire:submit.prevent='save'>
                    <div class="grid gap-y-4">
                      ...
                      <!-- Form Group -->
                      <div>
                        <label for="password_confirmation" class="block text-sm mb-2 dark:text-white">confirmation password</label>
                        <div class="relative">
                          <input type="password" id="password_confirmatio"  wire:model="password_confirmation" class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" aria-describedby="email-error">
