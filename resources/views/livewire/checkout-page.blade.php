                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model='street_adress' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="address" type="text">
                            </input>
                            @error('street_adress')
                                <div class=" text-red-600  text-sm">
                                    {{$message}}
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        <li>
                            <input    wire:model='payement_method' class="hidden peer" id="hosting-small" required="" type="radio"  value="cod" />
                            @error('payement_method')
                            <div class=" text-red-600  text-sm">
                                {{$message}}
                        ...
                        <li wire:key='{{$ci['product_id']}}'class="py-3 sm:py-4">
                            <div class="flex items-center">
                                ...
                                <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                    {{Number::currency($ci['totale_amount'],'MAD')}}
                                </div>
                            </div>
                        </li>
