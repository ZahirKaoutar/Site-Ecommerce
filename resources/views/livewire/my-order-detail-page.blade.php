          ...
          <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            <div class="p-4 md:p-5 flex gap-x-4">
              ...
              <div class="grow">
                ...
                <div class="mt-1 flex items-center gap-x-2">
                  <span class="bg-blue-500 py-1 px-3 rounded text-white shadow">{{$order->status}}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            <div class="p-4 md:p-5 flex gap-x-4">
              ...
              <div class="grow">
                ...
                <div class="mt-1 flex items-center gap-x-2">
                  <span class="bg-green-500 py-1 px-3 rounded text-white shadow">{{$order->payement_status}}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="md:w-3/4">
                ...
                <tbody>
                    ...
                    @foreach($order_items as $item)
                        <tr wire:key="{{$item->id}}">
                            ...
                            <td class="py-4">{{Number::currency($item->totale_amount,'MAD')}}</td>
                        </tr>
                      @endforeach
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
              ...
              <div class="flex justify-between items-center">
                <div>
                  <p>{{$adress->street_adress}},{{$adress->city}},{{$adress->state}},{{$adress->zip_code}}</p>
                </div>
                <div>
          ...
          <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
              ...
              <div class="flex justify-between mb-2">
                <span>Subtotal</span>
                <span>{{Number::currency($item->order->grand_totale,'MAD')}}</span>
              </div>
              <div class="flex justify-between mb-2">
                <span>Taxes</span>
                <span>0.00</span>
              ...
              <div class="flex justify-between mb-2">
                ...
                <span class="font-semibold">>{{Number::currency($item->order->grand_totale,'MAD')}}</span>
              </div>
